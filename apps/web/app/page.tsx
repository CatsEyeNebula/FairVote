...
function HomePage(): JSX.Element {
    return (
        <div className='p-3'>
            ...
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Accordion</h2>
                </header>
                <AccordionExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Avatar</h2>
                </header>
                <AvatarExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Badges</h2>
                </header>
                <BadgesExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Breadcrumb</h2>
                </header>
                <BreadcrumbExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Buttons</h2>
                </header>
                <ButtonsExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Button group</h2>
                </header>
                <ButtonGroupExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Card</h2>
                </header>
                <CardExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Carousel</h2>
                </header>
                <CarouselExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Dropdown</h2>
                </header>
                <DropdownExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Forms</h2>
                </header>
                <FormsExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Footer</h2>
                </header>
                <FooterExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>List group</h2>
                </header>
                <ListGroupExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Modal</h2>
                </header>
                <ModalExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Navbars</h2>
                </header>
                <NavbarsExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Pagination</h2>
                </header>
                <PaginationExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Progress</h2>
                </header>
                <ProgressExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Rating</h2>
                </header>
                <RatingExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Sidebar</h2>
                </header>
                <SidebarExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Spinners</h2>
                </header>
                <SpinnersExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Tables</h2>
                </header>
            ...
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Tabs</h2>
                </header>
                <TabsExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Timeline</h2>
                </header>
                <TimelineExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Toast</h2>
                </header>
                <ToastExample />
            </section>
            <section>
                <header>
                    <h2 className='mt-9 mb-3 text-4xl font-bold dark:text-gray-200'>Tooltips</h2>
                </header>
                <TooltipsExample />
            </section>
        </div>
        ...
        <Accordion flush>
            ...
            <Accordion.Panel>
                ...
                <Accordion.Content>
                    ...
                    <p className='mb-2 text-gray-500 dark:text-gray-400'>
                        However, we actually recommend using both Flowbite, Flowbite Pro, and even Tailwind UI as there
...
function AvatarExample(): JSX.Element {
    return <Avatar bordered img='https://flowbite.com/docs/images/people/profile-picture-5.jpg' rounded />;
}
    ...
    return (
        <Navbar fluid rounded>
            <Navbar.Brand href='https://flowbite.com/'>
                <Image alt='Flowbite logo' height='32' src='https://flowbite.com/docs/images/logo.svg' width='32' />
...
function ProgressExample(): JSX.Element {
    return <Progress progress={45} label='Flowbite' labelPosition='outside' labelProgress />;
}
